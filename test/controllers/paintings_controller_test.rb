...
class PaintingsControllerTest < ActionController::TestCase
  ...
  test "should create painting" do
    assert_difference('Painting.count') do
      post :create, painting: { dimentions: @painting.dimentions, technic: @painting.technic, title: @painting.title, year: @painting.year }
    end
  ...
  test "should update painting" do
    patch :update, id: @painting, painting: { dimentions: @painting.dimentions, technic: @painting.technic, title: @painting.title, year: @painting.year }
    assert_redirected_to painting_path(assigns(:painting))
  end
