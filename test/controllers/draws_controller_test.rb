...
class DrawsControllerTest < ActionController::TestCase
  ...
  test "should create draw" do
    assert_difference('Draw.count') do
      post :create, draw: { dimentions: @draw.dimentions, technic: @draw.technic, title: @draw.title, year: @draw.year }
    end
  ...
  test "should update draw" do
    patch :update, id: @draw, draw: { dimentions: @draw.dimentions, technic: @draw.technic, title: @draw.title, year: @draw.year }
    assert_redirected_to draw_path(assigns(:draw))
  end
