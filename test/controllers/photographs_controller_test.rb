...
class PhotographsControllerTest < ActionController::TestCase
  ...
  test "should create photograph" do
    assert_difference('Photograph.count') do
      post :create, photograph: { dimentions: @photograph.dimentions, technic: @photograph.technic, title: @photograph.title, year: @photograph.year }
    end
  ...
  test "should update photograph" do
    patch :update, id: @photograph, photograph: { dimentions: @photograph.dimentions, technic: @photograph.technic, title: @photograph.title, year: @photograph.year }
    assert_redirected_to photograph_path(assigns(:photograph))
  end
