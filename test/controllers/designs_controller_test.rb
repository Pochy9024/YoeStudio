...
class DesignsControllerTest < ActionController::TestCase
  ...
  test "should create design" do
    assert_difference('Design.count') do
      post :create, design: { dimentions: @design.dimentions, technic: @design.technic, title: @design.title, year: @design.year }
    end
  ...
  test "should update design" do
    patch :update, id: @design, design: { dimentions: @design.dimentions, technic: @design.technic, title: @design.title, year: @design.year }
    assert_redirected_to design_path(assigns(:design))
  end
